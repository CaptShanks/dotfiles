...
return {
  ...
  keys = {
    ...
    { "<leader>fh", function() vim.cmd("cd ~"); vim.notify("Changed to home directory") end, desc = "Go to Home" },
    { "<leader>fC", function() vim.cmd("cd " .. vim.fn.stdpath("config")); vim.notify("Changed to nvim config") end, desc = "Go to Config" },
  },
}